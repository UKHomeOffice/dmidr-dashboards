...
def auto_govuk_table(
    dFrame,
    title: str = None,
    title_size: str = "s",
    bold_lead: bool = False,
    hidden_lead_head: bool = False,
):
    """
    ...
    return html.Thead(
        ...
        children=[
            html.Tr(
                ...
                children=[
                    html.Th(className="govuk-table__header", scope="col", children=c)
                    for c in columns
                ],
            )
        ],
    ...
    return html.Tbody(
        ...
        children=[
            html.Tr(
                ...
                children=[
                    html.Td(className="govuk-table__cell", children=f"{v}") for v in row
                ],
            )
