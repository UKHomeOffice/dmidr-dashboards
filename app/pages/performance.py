...
dash.register_page(__name__, name="Performance summary", path="/performance-summary")
        ...
        html.Div(
            ...
            children=[
                html.Div(
                    ...
                    children=performance_bar(
                        get_mpam_performance_by_date(), plot_title="Performance"
                    ),
                ),
            ],
        ),
